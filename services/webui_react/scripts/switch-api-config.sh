...
ENV_FILE="/home/justloic/companies/from-first-principles/codebase/services/webui_react/.env.local"
...
echo "   cd /home/justloic/companies/from-first-principles/codebase/services/webui_react"
echo "   npm run dev"
